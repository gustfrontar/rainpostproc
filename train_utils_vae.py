...
def trainer( TrainConf , Data ) : 
    ...
    for epoch in range( TrainConf['MaxEpochs'] ):
        ...
        for inputs, target in TrainDataLoader :
            ...
            loss = vae_loss( outputs , target , loss_weights , mu , logvar  , lambda_mse = lambda_mse , 
                             lambda_kl = lambda_kl , lambda_var = lambda_var , lambda_skew = lambda_skew , 
